...
/// Program ID
pub const ID: Address = Address::new_from_array(five8_const::decode_32_const("BSwp6bEBihVLdqJRKGgzjcGLHkcTuzmSo1TQkHepzH8p"));
...
impl<'a> CreatepoolAccounts<'a> {
    ...
    pub fn to_views(&self) -> [&'a AccountView; 14] {
        [
            self.state, self.pool, self.token_x, self.token_y, self.pool_x_account, self.pool_y_account, self.admin_x_account, self.admin_y_account, self.admin, self.project_owner, self.program_authority, self.system_program, self.token_program, self.rent
        ]
    }
}
...
impl<'a> CreateproviderAccounts<'a> {
    ...
    pub fn to_views(&self) -> [&'a AccountView; 13] {
        [
            self.pool, self.farm, self.provider, self.token_x, self.token_y, self.pool_x_account, self.pool_y_account, self.owner_x_account, self.owner_y_account, self.owner, self.system_program, self.token_program, self.rent
        ]
    }
}
...
impl<'a> AddtokensAccounts<'a> {
    ...
    pub fn to_instruction_accounts(&self) -> [InstructionAccount<'a>; 25] {
        [
            ...
            InstructionAccount::readonly(self.token_x.address()),
            InstructionAccount::readonly(self.token_y.address()),
            InstructionAccount::writable(self.token_marco.address()),
            InstructionAccount::writable(self.token_project_first.address()),
            InstructionAccount::writable(self.token_project_second.address()),
            InstructionAccount::writable(self.owner_x_account.address()),
            InstructionAccount::writable(self.owner_y_account.address()),
            InstructionAccount::writable(self.pool_x_account.address()),
            InstructionAccount::writable(self.pool_y_account.address()),
    ...
    pub fn to_views(&self) -> [&'a AccountView; 25] {
        [
            self.state, self.pool, self.farm, self.provider, self.token_x, self.token_y, self.token_marco, self.token_project_first, self.token_project_second, self.owner_x_account, self.owner_y_account, self.pool_x_account, self.pool_y_account, self.owner_marco_account, self.owner_project_first_account, self.owner_project_second_account, self.token_marco_account, self.token_project_first_account, self.token_project_second_account, self.owner, self.program_authority, self.system_program, self.token_program, self.associated_token_program, self.rent
        ]
    }
}
...
impl<'a> WithdrawbuybackAccounts<'a> {
    ...
    pub fn to_views(&self) -> [&'a AccountView; 14] {
        [
            self.state, self.pool, self.token_x, self.token_y, self.buyback_x_account, self.buyback_y_account, self.pool_x_account, self.pool_y_account, self.admin, self.program_authority, self.system_program, self.token_program, self.associated_token_program, self.rent
        ]
    }
}
...
impl<'a> WithdrawsharesAccounts<'a> {
    ...
    pub fn to_views(&self) -> [&'a AccountView; 25] {
        [
            self.state, self.pool, self.farm, self.provider, self.token_x, self.token_y, self.token_marco, self.token_project_first, self.token_project_second, self.pool_x_account, self.pool_y_account, self.token_marco_account, self.token_project_first_account, self.token_project_second_account, self.owner_x_account, self.owner_y_account, self.owner_marco_account, self.owner_project_first_account, self.owner_project_second_account, self.owner, self.program_authority, self.system_program, self.token_program, self.associated_token_program, self.rent
        ]
    }
}
...
impl<'a> WithdrawlpfeeAccounts<'a> {
    ...
    pub fn to_views(&self) -> [&'a AccountView; 15] {
        [
            self.state, self.pool, self.provider, self.token_x, self.token_y, self.owner_x_account, self.owner_y_account, self.pool_x_account, self.pool_y_account, self.owner, self.program_authority, self.system_program, self.token_program, self.associated_token_program, self.rent
        ]
    }
}
...
impl<'a> WithdrawprojectfeeAccounts<'a> {
    ...
    pub fn to_views(&self) -> [&'a AccountView; 14] {
        [
            self.state, self.pool, self.token_x, self.token_y, self.project_owner_x_account, self.project_owner_y_account, self.pool_x_account, self.pool_y_account, self.project_owner, self.program_authority, self.system_program, self.token_program, self.associated_token_program, self.rent
        ]
    }
}
...
impl<'a> CreatefarmAccounts<'a> {
    ...
    pub fn to_views(&self) -> [&'a AccountView; 13] {
        [
            self.state, self.pool, self.farm, self.token_x, self.token_y, self.token_marco, self.token_marco_account, self.admin_marco_account, self.admin, self.program_authority, self.system_program, self.token_program, self.rent
        ]
    }
}
...
impl<'a> CreatedualfarmAccounts<'a> {
    ...
    pub fn to_views(&self) -> [&'a AccountView; 16] {
        [
            self.state, self.pool, self.farm, self.token_x, self.token_y, self.token_marco, self.token_project_first, self.token_marco_account, self.token_project_first_account, self.admin_marco_account, self.admin_project_first_account, self.admin, self.program_authority, self.system_program, self.token_program, self.rent
        ]
    }
}
...
impl<'a> CreatetriplefarmAccounts<'a> {
    ...
    pub fn to_views(&self) -> [&'a AccountView; 19] {
        [
            self.state, self.pool, self.farm, self.token_x, self.token_y, self.token_marco, self.token_project_first, self.token_project_second, self.token_marco_account, self.token_project_first_account, self.token_project_second_account, self.admin_marco_account, self.admin_project_first_account, self.admin_project_second_account, self.admin, self.program_authority, self.system_program, self.token_program, self.rent
        ]
    }
}
...
impl<'a> WithdrawrewardsAccounts<'a> {
    ...
    pub fn to_views(&self) -> [&'a AccountView; 21] {
        [
            self.state, self.pool, self.farm, self.provider, self.token_x, self.token_y, self.token_marco, self.token_project_first, self.token_project_second, self.token_marco_account, self.token_project_first_account, self.token_project_second_account, self.owner_marco_account, self.owner_project_first_account, self.owner_project_second_account, self.owner, self.program_authority, self.system_program, self.token_program, self.associated_token_program, self.rent
        ]
    }
}
...
impl<'a> ClosepoolAccounts<'a> {
    ...
    pub fn to_views(&self) -> [&'a AccountView; 15] {
        [
            self.state, self.pool, self.farm, self.token_x, self.token_y, self.token_marco_account, self.token_project_first_account, self.token_project_second_account, self.pool_x_account, self.pool_y_account, self.buyback_x_account, self.buyback_y_account, self.admin, self.program_authority, self.token_program
        ]
    }
}
...
impl<'a> WithdrawmercantifeeAccounts<'a> {
    ...
    pub fn to_views(&self) -> [&'a AccountView; 11] {
        [
            self.state, self.pool, self.token_x, self.token_y, self.mercanti_x_account, self.mercanti_y_account, self.pool_x_account, self.pool_y_account, self.admin, self.program_authority, self.token_program
        ]
    }
}
...
impl<'a> AddsupplyAccounts<'a> {
    ...
    pub fn to_views(&self) -> [&'a AccountView; 13] {
        [
            self.state, self.pool, self.farm, self.token_x, self.token_y, self.token_marco_account, self.token_project_first_account, self.token_project_second_account, self.admin_marco_account, self.admin_project_first_account, self.admin_project_second_account, self.admin, self.token_program
        ]
    }
}
...
impl<'a> UpdatefeesAccounts<'a> {
    ...
    pub fn to_views(&self) -> [&'a AccountView; 6] {
        [
            self.state, self.pool, self.token_x, self.token_y, self.admin, self.program_authority
        ]
    }
}
...
impl<'a> ResetfarmAccounts<'a> {
    ...
    pub fn to_views(&self) -> [&'a AccountView; 17] {
        [
            self.state, self.pool, self.farm, self.token_x, self.token_y, self.token_marco, self.token_marco_account, self.token_project_first_account, self.token_project_second_account, self.admin_marco_account, self.admin_project_first_account, self.admin_project_second_account, self.admin, self.program_authority, self.system_program, self.token_program, self.rent
        ]
    }
}
