//! CPI module for Stabble Stable Swap
//!
//! Program: stable_swap
...
/// Program ID
pub const ID: Address = Address::new_from_array(five8_const::decode_32_const("swapNyd8XiQwJ6ianp9snpu4brUqFxadzvHebnAXjJZ"));

// ============================================
// Instruction Discriminators
// ============================================
pub const ACCEPT_OWNER: [u8; 8] = [176, 23, 41, 28, 23, 111, 8, 4];
pub const APPROVE_STRATEGY: [u8; 8] = [7, 141, 162, 60, 71, 115, 26, 146];
pub const CHANGE_AMP_FACTOR: [u8; 8] = [56, 238, 189, 35, 200, 157, 42, 66];
pub const CHANGE_MAX_SUPPLY: [u8; 8] = [93, 176, 0, 205, 69, 63, 87, 80];
pub const CHANGE_SWAP_FEE: [u8; 8] = [231, 15, 132, 51, 132, 165, 64, 170];
pub const CHANGE_SWAP_FEE_PRIVILEGED: [u8; 8] = [155, 200, 14, 91, 105, 38, 220, 119];
pub const CLOSE_STRATEGY: [u8; 8] = [56, 247, 170, 246, 89, 221, 134, 200];
pub const CREATE_STRATEGY: [u8; 8] = [152, 160, 107, 148, 245, 190, 127, 224];
pub const DEPOSIT: [u8; 8] = [242, 35, 198, 137, 82, 225, 242, 182];
pub const EXEC_STRATEGY: [u8; 8] = [249, 46, 55, 57, 31, 38, 61, 27];
...
// ============================================
/// Arguments for `change_amp_factor`
#[derive(Clone, Copy)]
#[repr(C, packed)]
pub struct ChangeAmpFactorArgs {
...
/// Arguments for `change_swap_fee_privileged`
#[derive(Clone, Copy)]
#[repr(C, packed)]
pub struct ChangeSwapFeePrivilegedArgs {
    pub new_swap_fee: u64,
}

/// Arguments for `create_strategy`
#[derive(Clone, Copy)]
#[repr(C, packed)]
...
/// Arguments for `exec_strategy`
#[derive(Clone, Copy)]
#[repr(C, packed)]
pub struct ExecStrategyArgs {
    pub ramp_step: u16,
    pub ramp_duration: u32,
}
...
/// Accounts for `approve_strategy`
pub struct ApproveStrategyAccounts<'a> {
    /// admin_only
    pub admin_only: &'a AccountView,
    /// strategy
    pub strategy: &'a AccountView,
}

impl<'a> ApproveStrategyAccounts<'a> {
    /// Convert to InstructionAccount array
    #[inline(always)]
    pub fn to_instruction_accounts(&self) -> [InstructionAccount<'a>; 2] {
        [
            InstructionAccount::readonly(self.admin_only.address()),
    ...
    pub fn to_views(&self) -> [&'a AccountView; 2] {
        [
            self.admin_only, self.strategy
        ]
    }
}

/// Accounts for `change_amp_factor`
pub struct ChangeAmpFactorAccounts<'a> {
    /// pool
    pub pool: &'a AccountView,
    /// vault
...
impl<'a> ChangeAmpFactorAccounts<'a> {
    /// Convert to InstructionAccount array
    #[inline(always)]
    ...
    pub fn to_views(&self) -> [&'a AccountView; 3] {
        [
            self.pool, self.vault, self.admin
        ]
    }
}
...
/// Accounts for `change_swap_fee_privileged`
pub struct ChangeSwapFeePrivilegedAccounts<'a> {
    /// pool
    pub pool: &'a AccountView,
    /// vault
    pub vault: &'a AccountView,
...
impl<'a> ChangeSwapFeePrivilegedAccounts<'a> {
    /// Convert to InstructionAccount array
    #[inline(always)]
    pub fn to_instruction_accounts(&self) -> [InstructionAccount<'a>; 3] {
        [
...
/// Accounts for `close_strategy`
pub struct CloseStrategyAccounts<'a> {
    /// owner_only
    pub owner_only: &'a AccountView,
    /// strategy
    pub strategy: &'a AccountView,
    /// rent_collector
    pub rent_collector: &'a AccountView,
}

impl<'a> CloseStrategyAccounts<'a> {
    /// Convert to InstructionAccount array
    #[inline(always)]
    pub fn to_instruction_accounts(&self) -> [InstructionAccount<'a>; 3] {
        [
            InstructionAccount::readonly(self.owner_only.address()),
            InstructionAccount::writable(self.strategy.address()),
            InstructionAccount::writable(self.rent_collector.address()),
        ]
    }
    ...
    pub fn to_views(&self) -> [&'a AccountView; 3] {
        [
            self.owner_only, self.strategy, self.rent_collector
        ]
    }
}

/// Accounts for `create_strategy`
pub struct CreateStrategyAccounts<'a> {
    /// owner_only
    pub owner_only: &'a AccountView,
    /// strategy
    pub strategy: &'a AccountView,
...
impl<'a> CreateStrategyAccounts<'a> {
    /// Convert to InstructionAccount array
    #[inline(always)]
    pub fn to_instruction_accounts(&self) -> [InstructionAccount<'a>; 2] {
        [
...
/// Accounts for `exec_strategy`
pub struct ExecStrategyAccounts<'a> {
    /// strategy
    pub strategy: &'a AccountView,
    /// pool
    pub pool: &'a AccountView,
...
/// CPI: approve_strategy
#[inline(always)]
pub fn approve_strategy<'a>(
    accounts: &ApproveStrategyAccounts<'a>,
    signers: &[Signer<'_, '_>],
) -> ProgramResult {
    // Build instruction data
    let mut data = [0u8; 8 + 0];
    data[0..8].copy_from_slice(&APPROVE_STRATEGY);
...
/// CPI: change_amp_factor
#[inline(always)]
pub fn change_amp_factor<'a>(
    accounts: &ChangeAmpFactorAccounts<'a>, args: &ChangeAmpFactorArgs,
    signers: &[Signer<'_, '_>],
) -> ProgramResult {
    // Build instruction data
    let mut data = [0u8; 8 + core::mem::size_of::<ChangeAmpFactorArgs>()];
    data[0..8].copy_from_slice(&CHANGE_AMP_FACTOR);
    
        // Copy arguments (unsafe due to packed struct)
        unsafe {
            core::ptr::copy_nonoverlapping(
                args as *const ChangeAmpFactorArgs as *const u8,
                data.as_mut_ptr().add(8),
                core::mem::size_of::<ChangeAmpFactorArgs>(),
            );
        }
...
/// CPI: change_swap_fee_privileged
#[inline(always)]
pub fn change_swap_fee_privileged<'a>(
    accounts: &ChangeSwapFeePrivilegedAccounts<'a>, args: &ChangeSwapFeePrivilegedArgs,
    signers: &[Signer<'_, '_>],
) -> ProgramResult {
    // Build instruction data
    let mut data = [0u8; 8 + core::mem::size_of::<ChangeSwapFeePrivilegedArgs>()];
    data[0..8].copy_from_slice(&CHANGE_SWAP_FEE_PRIVILEGED);
    
        // Copy arguments (unsafe due to packed struct)
        unsafe {
            core::ptr::copy_nonoverlapping(
                args as *const ChangeSwapFeePrivilegedArgs as *const u8,
                data.as_mut_ptr().add(8),
                core::mem::size_of::<ChangeSwapFeePrivilegedArgs>(),
            );
        }
...
/// CPI: close_strategy
#[inline(always)]
pub fn close_strategy<'a>(
    accounts: &CloseStrategyAccounts<'a>,
    signers: &[Signer<'_, '_>],
) -> ProgramResult {
    // Build instruction data
    let mut data = [0u8; 8 + 0];
    data[0..8].copy_from_slice(&CLOSE_STRATEGY);
...
pub fn create_strategy<'a>(
    accounts: &CreateStrategyAccounts<'a>, args: &CreateStrategyArgs,
    signers: &[Signer<'_, '_>],
) -> ProgramResult {
    // Build instruction data
    let mut data = [0u8; 8 + core::mem::size_of::<CreateStrategyArgs>()];
    data[0..8].copy_from_slice(&CREATE_STRATEGY);
    
        // Copy arguments (unsafe due to packed struct)
        unsafe {
            core::ptr::copy_nonoverlapping(
                args as *const CreateStrategyArgs as *const u8,
                data.as_mut_ptr().add(8),
                core::mem::size_of::<CreateStrategyArgs>(),
            );
        }
...
/// CPI: exec_strategy
#[inline(always)]
pub fn exec_strategy<'a>(
    accounts: &ExecStrategyAccounts<'a>, args: &ExecStrategyArgs,
    signers: &[Signer<'_, '_>],
) -> ProgramResult {
    // Build instruction data
    let mut data = [0u8; 8 + core::mem::size_of::<ExecStrategyArgs>()];
    data[0..8].copy_from_slice(&EXEC_STRATEGY);
    
        // Copy arguments (unsafe due to packed struct)
        unsafe {
            core::ptr::copy_nonoverlapping(
                args as *const ExecStrategyArgs as *const u8,
                data.as_mut_ptr().add(8),
                core::mem::size_of::<ExecStrategyArgs>(),
            );
        }
