...
/// Program ID
pub const ID: Address = Address::new_from_array(five8_const::decode_32_const("HpNfyc2Saw7RKkQd8nEL4khUcuPhQ7WwY1B2qjx8jxFq"));
...
pub const CREATE_PERMISSIONLESS_FARM_SWITCH: [u8; 8] = [88, 242, 198, 70, 241, 6, 196, 251];
...
pub const TOGGLE_PERMISSIONLESS_FARM_SWITCH: [u8; 8] = [150, 112, 54, 233, 238, 161, 7, 86];
...
/// Arguments for `swap_router_base_in`
#[derive(Clone, Copy)]
#[repr(C, packed)]
pub struct SwapRouterBaseInArgs {
    pub amount_in: u64,
...
/// Arguments for `toggle_permissionless_farm_switch`
#[derive(Clone, Copy)]
#[repr(C, packed)]
pub struct TogglePermissionlessFarmSwitchArgs {
    pub is_on: bool,
}
...
impl<'a> CollectFundFeeAccounts<'a> {
    ...
    pub fn to_views(&self) -> [&'a AccountView; 11] {
        [
            self.owner, self.pool_state, self.amm_config, self.token_vault_0, self.token_vault_1, self.vault_0_mint, self.vault_1_mint, self.recipient_token_account_0, self.recipient_token_account_1, self.token_program, self.token_program_2022
        ]
    }
}
...
impl<'a> CollectRemainingRewardsAccounts<'a> {
    ...
    pub fn to_views(&self) -> [&'a AccountView; 8] {
        [
            self.reward_funder, self.funder_token_account, self.pool_state, self.reward_token_vault, self.reward_vault_mint, self.token_program, self.token_program_2022, self.memo_program
        ]
    }
}
...
impl<'a> CreateOperationAccountAccounts<'a> {
    ...
    pub fn to_views(&self) -> [&'a AccountView; 3] {
        [
            self.owner, self.operation_state, self.system_program
        ]
    }
}

/// Accounts for `create_permissionless_farm_switch`
pub struct CreatePermissionlessFarmSwitchAccounts<'a> {
    /// owner
    pub owner: &'a AccountView,
    /// permissionless_farm_switch
    pub permissionless_farm_switch: &'a AccountView,
    /// system_program
    pub system_program: &'a AccountView,
}

impl<'a> CreatePermissionlessFarmSwitchAccounts<'a> {
    /// Convert to InstructionAccount array
    #[inline(always)]
    pub fn to_instruction_accounts(&self) -> [InstructionAccount<'a>; 3] {
        [
            InstructionAccount::writable_signer(self.owner.address()),
            InstructionAccount::writable(self.permissionless_farm_switch.address()),
            InstructionAccount::readonly(self.system_program.address()),
        ]
    }
    ...
    pub fn to_views(&self) -> [&'a AccountView; 3] {
        [
            self.owner, self.permissionless_farm_switch, self.system_program
        ]
    }
}
...
impl<'a> CreatePoolAccounts<'a> {
    ...
    pub fn to_views(&self) -> [&'a AccountView; 13] {
        [
            self.pool_creator, self.amm_config, self.pool_state, self.token_mint_0, self.token_mint_1, self.token_vault_0, self.token_vault_1, self.observation_state, self.tick_array_bitmap, self.token_program_0, self.token_program_1, self.system_program, self.rent
        ]
    }
}
...
impl<'a> CreateSupportMintAssociatedAccounts<'a> {
    ...
    pub fn to_views(&self) -> [&'a AccountView; 4] {
        [
            self.owner, self.token_mint, self.support_mint_associated, self.system_program
        ]
    }
}
...
impl<'a> InitializeRewardAccounts<'a> {
    ...
    pub fn to_instruction_accounts(&self) -> [InstructionAccount<'a>; 11] {
        [
            ...
            InstructionAccount::readonly(self.permissionless_farm_switch.address()),
    ...
    pub fn to_views(&self) -> [&'a AccountView; 11] {
        [
            self.reward_funder, self.funder_token_account, self.amm_config, self.pool_state, self.operation_state, self.permissionless_farm_switch, self.reward_token_mint, self.reward_token_vault, self.reward_token_program, self.system_program, self.rent
        ]
    }
}
...
impl<'a> SetRewardParamsAccounts<'a> {
    ...
    pub fn to_views(&self) -> [&'a AccountView; 6] {
        [
            self.authority, self.amm_config, self.pool_state, self.operation_state, self.token_program, self.token_program_2022
        ]
    }
}
...
/// Accounts for `swap_router_base_in`
pub struct SwapRouterBaseInAccounts<'a> {
    /// The user performing the swap
    pub payer: &'a AccountView,
...
impl<'a> SwapRouterBaseInAccounts<'a> {
    /// Convert to InstructionAccount array
    #[inline(always)]
    pub fn to_instruction_accounts(&self) -> [InstructionAccount<'a>; 6] {
        [
            InstructionAccount::readonly_signer(self.payer.address()),
            InstructionAccount::writable(self.input_token_account.address()),
            InstructionAccount::writable(self.input_token_mint.address()),
            InstructionAccount::readonly(self.token_program.address()),
            InstructionAccount::readonly(self.token_program_2022.address()),
            InstructionAccount::readonly(self.memo_program.address()),
        ]
    ...
    pub fn to_views(&self) -> [&'a AccountView; 6] {
        [
            self.payer, self.input_token_account, self.input_token_mint, self.token_program, self.token_program_2022, self.memo_program
        ]
    }
}
...
/// Accounts for `toggle_permissionless_farm_switch`
pub struct TogglePermissionlessFarmSwitchAccounts<'a> {
    /// owner
    pub owner: &'a AccountView,
    /// permissionless_farm_switch
    pub permissionless_farm_switch: &'a AccountView,
...
impl<'a> TogglePermissionlessFarmSwitchAccounts<'a> {
    /// Convert to InstructionAccount array
    #[inline(always)]
    pub fn to_instruction_accounts(&self) -> [InstructionAccount<'a>; 3] {
        [
...
/// CPI: create_permissionless_farm_switch
#[inline(always)]
pub fn create_permissionless_farm_switch<'a>(
    accounts: &CreatePermissionlessFarmSwitchAccounts<'a>,
    signers: &[Signer<'_, '_>],
) -> ProgramResult {
    // Build instruction data
    let mut data = [0u8; 8 + 0];
    data[0..8].copy_from_slice(&CREATE_PERMISSIONLESS_FARM_SWITCH);
...
/// CPI: swap_router_base_in
#[inline(always)]
pub fn swap_router_base_in<'a>(
    accounts: &SwapRouterBaseInAccounts<'a>, args: &SwapRouterBaseInArgs,
    signers: &[Signer<'_, '_>],
) -> ProgramResult {
    // Build instruction data
    let mut data = [0u8; 8 + core::mem::size_of::<SwapRouterBaseInArgs>()];
    data[0..8].copy_from_slice(&SWAP_ROUTER_BASE_IN);
    
        // Copy arguments (unsafe due to packed struct)
        unsafe {
            core::ptr::copy_nonoverlapping(
                args as *const SwapRouterBaseInArgs as *const u8,
                data.as_mut_ptr().add(8),
                core::mem::size_of::<SwapRouterBaseInArgs>(),
            );
        }
...
/// CPI: toggle_permissionless_farm_switch
#[inline(always)]
pub fn toggle_permissionless_farm_switch<'a>(
    accounts: &TogglePermissionlessFarmSwitchAccounts<'a>, args: &TogglePermissionlessFarmSwitchArgs,
    signers: &[Signer<'_, '_>],
) -> ProgramResult {
    // Build instruction data
    let mut data = [0u8; 8 + core::mem::size_of::<TogglePermissionlessFarmSwitchArgs>()];
    data[0..8].copy_from_slice(&TOGGLE_PERMISSIONLESS_FARM_SWITCH);
    
        // Copy arguments (unsafe due to packed struct)
        unsafe {
            core::ptr::copy_nonoverlapping(
                args as *const TogglePermissionlessFarmSwitchArgs as *const u8,
                data.as_mut_ptr().add(8),
                core::mem::size_of::<TogglePermissionlessFarmSwitchArgs>(),
            );
        }
